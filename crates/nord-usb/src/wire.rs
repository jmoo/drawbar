...
impl Partition {
    ...
    ///
    /// Library partitions report a storage block minus its own overhead: pianos
    /// `261632` (256 KiB − 512), samples `131064` (128 KiB − 8). Slot-addressed
    /// partitions report `1`, which is what says their counters are byte-granular.
    ///
...
impl Status {
    ...
    /// variable-size content and yield `None`.
